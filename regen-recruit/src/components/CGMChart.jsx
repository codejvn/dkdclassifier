// ─── CGM Chart — classic light-theme Recharts ────────────────────────────────
import {
...
export default function CGMChart({ data }) {
  ...
  return (
    ...
    >
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={sampled} margin={{ top: 4, right: 14, bottom: 0, left: 0 }}>
          <CartesianGrid strokeDasharray="2 4" stroke="#e0e0e0" vertical={false} />

          {/* Target range lines */}
          <ReferenceLine y={180} stroke="#996600" strokeDasharray="4 3" strokeWidth={1} label={{ value: '180', position: 'right', fontSize: 9, fill: '#996600' }} />
          <ReferenceLine y={70}  stroke="#996600" strokeDasharray="4 3" strokeWidth={1} label={{ value: '70',  position: 'right', fontSize: 9, fill: '#996600' }} />

          <XAxis dataKey="time" tick={TICK} interval={11} axisLine={{ stroke: '#aaa' }} tickLine={{ stroke: '#aaa' }} />
